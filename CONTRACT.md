# projectkit contract — v1.0.0

> This is the published interface Agents B (testbeds) and C (flywheel) pin to.
> Pin a caret range: `"@operator/projectkit": "^0.1.0"` (package), contract
> semver `1.0.0`. Breaking the wire shape requires a major bump + a migration note here.
